...
$(document).ready(function() {
	...
	$("#hideMe").toggle(function() {
		$("#browser").animate({ "margin-left": "-350px", 'boxShadowX': '0px', 'boxShadowY':'0px', 'boxShadowBlur': '0px'}, "slow");
	}, function () {
		$("#browser").animate({ "margin-left": "0px", 'boxShadowX': '5px', 'boxShadowY':'0px', 'boxShadowBlur': '15px'}, "slow");
	});
